...
public class SettingsActivity extends AppCompatActivity {
    ...
    private EditText nameEditText , phoneEditText ,carNameEdittext ;
    private ImageView close , save ;
    private TextView profile_change_btn  ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getType.equals("Drivers")){
            carNameEdittext.setVisibility(View.VISIBLE);
        }
    ...
    private void closButton() {
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (getType.equals("Drivers")){

                    startActivity(new Intent(getApplicationContext(),DriversMapsActivity.class));
                }else {
                    startActivity(new Intent(getApplicationContext(),CustomersMapActivity.class));
                }
            }
        });
    }
    ...
    private void initialVariable() {
        ...
        carNameEdittext=findViewById(R.id.driver_car_name);
        close=findViewById(R.id.close_button);
        save=findViewById(R.id.save_button);
        profile_change_btn = findViewById(R.id.change_picture_btn);
    ...
    private void validateControllers(){
        ...
        if (TextUtils.isEmpty(phoneEditText.getText().toString())){
            phoneEditText.setError("please , provide your phone");
        }
        else
        if (  getType.equals("Drivers") && TextUtils.isEmpty(carNameEdittext.getText().toString())){
            carNameEdittext.setError("please , provide your car name ");
        }
        else
            if (checker.equals("clicked")){
    ...
    private void uploadProfilePicture() {
        ...
        if (uri != null){
            ...
            uploadTask=fileRef.getFile(uri);
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()){
                        Uri downloaUri = task.getResult();
                        muUrl = downloaUri.toString();
                        ...
                        if (getType.equals("Drivers")){
                            userMap.put("car",carNameEdittext.getText().toString());
